...
class M_galeri extends CI_Model{
	...
	function get_galeri_by_album_id($kode){
		$hsl=$this->db->query("SELECT tbl_galeri.*,DATE_FORMAT(galeri_tanggal,'%d/%m/%Y') AS tanggal,album_nama FROM tbl_galeri join tbl_album on galeri_album_id=album_id where galeri_album_id='$kode' ORDER BY galeri_id DESC limit 10");
		return $hsl;
	}
	function galeri(){
	...
	function limit_galeri(){
		$hsl=$this->db->query("SELECT * FROM tbl_galeri ORDER BY galeri_id DESC limit 10");
		return $hsl;
	}
