...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | Data Seting</title>
      ...
      <div class="row">
        ...
        <?php foreach ($data->result_array() as $i) :
                ...
                <tr>
                  ...
                  <td><?php echo $pengguna_alamat;?></td>
                  <td><?php echo $pengguna_map;?></td> 
                  <td><?php echo $pengguna_yt;?></td> 
                  <td><?php echo $pengguna_nohp;?></td>
                  <td><?php echo $pengguna_facebook;?></td>
                  <td><?php echo $pengguna_twitter;?></td>
                  <td><?php echo $pengguna_ig;?></td>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $pengguna_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Pengaturan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/seting/simpan_identiitas'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xalamat" class="form-control" value="<?php echo $pengguna_alamat;?>" id="inputUserName" placeholder="Username" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Map</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xmap" value="<?php echo $pengguna_map;?>" class="form-control" id="inputPassword3" placeholder="Map">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword4" class="col-sm-4 control-label">Youtube</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xyoutube" value="<?php echo $pengguna_yt;?>" class="form-control" id="inputPassword4" placeholder="Link Youtube">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Telp</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtelp" class="form-control" value="<?php echo $pengguna_nohp;?>" id="inputUserName" placeholder="Kontak Person" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Facebook</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xfb" class="form-control" value="<?php echo $pengguna_facebook;?>" id="inputUserName" placeholder="Facebook" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Twitter</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtwit" class="form-control" value="<?php echo $pengguna_twitter;?>" id="inputUserName" placeholder="Twitter" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Instagram</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xig" class="form-control" value="<?php echo $pengguna_ig;?>" id="inputUserName" placeholder="Instagram" required>
                                        </div>
                                    </div>
