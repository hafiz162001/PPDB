            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/galery/'.$galeri_gambar;?>" style="width:80px;"></td>
                  ...
                  <td style="text-align:right;">
                        ...
                        <a href="<?php echo base_url('admin/galeri/dwonload/');?><?php echo $galeri_id;?>" class="btn"><span class="fa fa-file"></span></a>
