...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | Data Guru</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Guru</a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					  ...
          					  $guru_kategori_id=$i['guru_kategori_id'];
                      $nama_guru_kategori=$i['nama_guru_kategori'];
                      $guru_author=$i['guru_author'];
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/'.$photo;?>" style="width:80px;"></td>
                  <td><?php echo $nama_guru;?></td>
        				  <td><?php echo $guru_tanggal;?></td>
                  <td><?php echo $keterangan;?></td>
                  <td><?php echo $nama_guru_kategori;?></td>
                  <td><?php echo $guru_author;?></td>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $id_guru;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_guru;?>"><span class="fa fa-trash"></span></a>
...
<!-- ./wrapper -->
                                        ...
                                        <div class="col-sm-7">
                                            <select  class="form-control" name="xkategori" style="width: 100%;" required>
                                              ...
                                              foreach ($kategori->result_array() as $i) :
                                                ...
                                                ?>
                                                    <option value="<?php echo $id_guru_kategori;?>"><?php echo $nama_guru_kategori;?></option>
                                              <?php endforeach;?>
                                          </select>                                        
                                        </div>
                                    </div>
  ...
  <!--Modal Edit Guru-->
          ...
          foreach ($data->result_array() as $i) :
              ...
              $guru_author=$i['guru_author'];
          ?>
        <div class="modal fade" id="ModalEdit<?php echo $guru_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="filefoto">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" value="<?php echo $nama_guru;?>" id="inputUserName" placeholder="Nama" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">keterangan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xketerangan" value="<?php echo $keterangan;?>" class="form-control" id="inputUserName" placeholder="Jabatan" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-7">
                                           <select class="form-control" name="xkategori" style="width: 100%;" required>
                                              ...
                                              foreach ($kategori->result_array() as $a) {
                                                           $id_guru_kategori=$a['id_guru_kategori'];
                                                           $nama_guru_kategori=$a['nama_guru_kategori'];
                                                           if($guru_kategori_id==$id_guru_kategori)
                                                              echo "<option value='$id_guru_kategori' selected>$nama_guru_kategori</option>";
                                                           else
                                                              echo "<option value='$id_guru_kategori'>$nama_guru_kategori</option>";
                                                        }?>
                                          </select>
                                        </div>
                                    </div>
  ...
  <?php endforeach;?>
	...
	<?php
          ...
          ?>
	<!--Modal Hapus Guru-->
        <div class="modal fade" id="ModalHapus<?php echo $guru_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus guru <b><?php echo $nama_guru;?></b> ?</p>
