      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
             ...
             <textarea name="xisi" id="editor1" class="form-control ckeditor"><?php echo $b['tulisan_isi'];?></textarea>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input type="text" name="xdrive" class="form-control"value="<?php echo $b['link_driv'];?>" placeholder="Link Download" />
              </div>
              <div class="form-group">
