...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | Kategori Berita</title>
              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $id_video;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_video;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Video</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xvideo" class="form-control" id="inputUserName" placeholder="video" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input type="text" name="xvideo" class="form-control" id="inputUserName" value="<?php echo $link_video;?>" placeholder="Video" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_video;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id_video;?>"/>
                            <p>Apakah Anda yakin mau menghapus Pengguna <b><?php echo $link_video;?></b> ?</p>
