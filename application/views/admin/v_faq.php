        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Ekstrakulikuler</a>
            </div>
            <!-- /.box-header -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Ekstrakulikuler</h4>
                    </div>
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ekstrakulikuler</label>
                          <div class="col-sm-7">
                              <input type="text" name="xtanya" class="form-control" id="inputUserName" placeholder="Nama Ekstrakulikuler" required>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
                          <div class="col-sm-7">
                            <textarea class="form-control" name="xjawab" rows="5" placeholder="Deksripsi ..."></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Nama Ekstrakulikuler</label>
                          <div class="col-sm-7">
                            ...
                            <textarea class="form-control" name="xtanya" rows="3" placeholder="Nama Ekstrakulikuler"><?php echo $tanya;?></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Deksripsi</label>
                          <div class="col-sm-7">
                            <textarea class="form-control" name="xjawab" rows="6" placeholder="Deskrpsi..."><?php echo $jawab;?></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Posisi</label>
                          <div class="col-sm-7">
                            <select class="form-control" name="xstat" required>
                            <?php if($stat=='1'):?>
                              <option value="1" selected="">Pilihan</option>
                              <option value="2">Wajib</option>
                            <?php else:?>
                              <option value="1">Pilihan</option>
                              <option value="2" selected="">Wajib</option>
                            <?php endif;?>
                            </select>
                          </div>
                      </div>
