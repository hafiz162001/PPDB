...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | List Berita</title>
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   $no++;
          					   $kode=$i['id_program'];
          					   $deskripsi_program=$i['deskripsi_program'];
                    ?>
                <tr>
                  <td style="width:33%;"><?php echo $deskripsi_program;?></td>

                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/tulisan/get_edit/'.$kode;?>"><span class="fa fa-pencil"></span></a>
