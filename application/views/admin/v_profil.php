        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url().'assets/images/'.$c['pengguna_photo'];?>" alt="User profile picture">

              <h3 class="profile-username text-center"><?php echo $c['pengguna_nama'];?></h3>
              <?php if($c['pengguna_level']=='1'):?>
              <p class="text-muted text-center">Administrator</p>
              <?php else:?>
              <p class="text-muted text-center">Editor</p>
              <?php endif;?>
            <!-- /.box-header -->
            <div class="box-body">
