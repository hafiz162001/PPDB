 ...
 <?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- SELECT2 EXAMPLE  Plugin-->
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Post Program</h3>
        </div>

		<form action="<?php echo base_url().'admin/program/simpan_program'?>" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <textarea name="xdeskripsi" id="editor1" class="form-control ckeditor"></textarea>
...
<script>
 CKEDITOR.replace( 'editor1', {
  height: 300,
  filebrowserUploadUrl: '<?php echo base_url('index.php/welcome/uploadfile') ?>'
 });
</script>>
