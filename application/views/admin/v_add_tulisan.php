      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <textarea name="xisi" id="editor1" class="form-control ckeditor"></textarea>
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input type="text" name="xdrive" class="form-control" placeholder="Link Download" />
              </div>
              <div class="form-group">
