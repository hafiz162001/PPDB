...
<!-- ======= Guru Header ======= -->
    ...
    <div class="col-md-6" style="margin-left: 300px;">
        <div class="box-header">
            <h1>Guru & Staff Ishlahulummah Boarding School</h1>
        </div>
    </div>
    <!-- End Guru Header -->
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 wow slideInRight" data-wow-duration="2s" data-wow-delay=".2s">
            <div class="awesome-menu ">
              <ul class="project-menu">
                ...
                <?php
                    foreach ($guru_kategori->result() as $row) : ?>
                <li>
                  <a href="#" data-filter=".<?php echo $row->id_guru_kategori;?>"><?php echo $row->nama_guru_kategori;?></a>
                </li>
              <?php endforeach;?>
              </ul>
            </div>
        ...
        <div class="awesome-project-content wow slideInLeft" data-wow-duration="2s" data-wow-delay=".2s">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 design <?php echo $row->guru_kategori_id;?>">
            <div class="single-team-member">
                    <div class="team-img">
                      <a href="#">
                        <img src="<?php echo base_url().'assets/images/'.$row->photo;?>" alt="">
                      </a>
